    ...
    with st.chat_message("assistant"):
        ...
        # B. 제품 추천 상담
            ...
            with st.spinner("장부 확인 중..."):
                ...
                # [에러 방지 핵심] AI에게는 데이터프레임 없이 순수 텍스트(role, content)만 추출해서 전달
                ...
                [절대 규칙]
                1. '지침', '재고 리스트' 같은 내부 운영 용어는 손님에게 절대 노출하지 마.
                ...
                [영업 지침]
                - 제공된 재고({stock_list}) 중 질문에 가장 적합한 모델 딱 하나만 양식에 맞춰 추천해.
                - 이전 대화 흐름을 기억해서 자연스럽게 답변을 이어가.
                - '녀석' 표현 절대 금지.
